...
def init_training_pipeline(config):
    ...
    train_dataset = pd.read_csv('translated-train-400-2500.csv', encoding='utf-8', error_bad_lines=False, engine="python")
    train_dataset = train_dataset[['ementa','inteiro_teor']]
    print('Exemplo de textos:')
    print(train_dataset.head(), '\n\n')
    
    val_dataset = pd.read_csv('translated-validate-400-2500.csv', encoding='utf-8', error_bad_lines=False, engine="python")
